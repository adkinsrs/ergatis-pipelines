...
if (!defined $hConfig{'indel_realigner'}{'GATK_BIN_DIR'}[0]) {
    $hConfig{'indel_realigner'}{'GATK_BIN_DIR'}[0] = GATK_BIN_DIR;
}
...
$sCmd  .= " -Djava.io.tmpdir=$hCmdLineOption{tmpdir} -jar " .  $hConfig{'indel_realigner'}{'GATK_BIN_DIR'}[0] . "/GenomeAnalysisTK.jar -T IndelRealigner " . 
