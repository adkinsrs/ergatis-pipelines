...
if (!defined $hConfig{'realigner_target_creator'}{'GATK_BIN_DIR'}[0]) {
    $hConfig{'realigner_target_creator'}{'GATK_BIN_DIR'}[0] = GATK_BIN_DIR;
}
...
$sCmd  .= " -Djava.io.tmpdir=$hCmdLineOption{tmpdir} -jar " . $hConfig{'realigner_target_creator'}{'GATK_BIN_DIR'}[0] . "/GenomeAnalysisTK.jar -T RealignerTargetCreator " . 
...
$hConfig{'indel_realigner'}{'Prefix'}[0] = $hConfig{'realigner_target_creator'}{'Prefix'}[0] ;
